      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-1 sm:gap-2">
          <button
            ...
            className="px-2 sm:px-4 py-1.5 sm:py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all flex items-center gap-1 sm:gap-2 shadow-sm text-sm"
          >
          ...
          <button
            ...
            className="px-2 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all flex items-center gap-1 sm:gap-2 shadow-sm text-sm"
          >
            <Plus className="w-5 h-5" />
            <span className="hidden sm:inline">Nuovo Piatto</span>
            <span className="sm:hidden">Piatto</span>
          </button>
        </div>
      </div>
